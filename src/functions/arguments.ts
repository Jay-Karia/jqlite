 ...
 * @param {Functions} node The AST node containing the function to check
 * @throws {EvaluatorError} If the number of arguments is incorrect
 */
export function checkNumberOfArgs(node: FunctionNode): void {
 ...
 */
export function checkSortArguments(node: FunctionNode): SortArgs {
 ...
 */
export function checkSubstringArguments(node: FunctionNode): SubstringArgs {
  // Get the function arguments
  const functionArgs = node.functionArgs;
 ...
 * @throws {EvaluatorError} If the arguments are incorrect
 */
export function checkEqualsArguments(node: FunctionNode): string {
  // Get the function arguments
  const functionArgs = node.functionArgs;
